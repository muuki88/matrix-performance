 ...
 * @see http://www.javaspecialists.eu/archive/Issue029.html
 */
public class MemoryTestBench {
	...
	public void showMemoryUsage(ObjectFactory factory) {
		...
		System.out.println(factory.getClass().getName() + " produced " + factory.makeObject().getClass().getName() + " which took " + mem
				+ " bytes");
	}
}
